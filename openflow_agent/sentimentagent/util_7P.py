...
For each comment, identify and extract relative nouns of 7Ps from and only from the comment. Output the analysis result of each comment in JSON format in one line, with the 7Ps as the main key and the corresponding nouns as the values. The order of the main key is: Product, Promotion, Price, Place, People, Process, Physical evidence.
...
"""
    ...
    return [_log, _7P_str, _total_cost_str]
